...
/***********比类型一增加的部分⏬*************************************/
            //设置内容范围
            _topTitleView.contentSize = CGSizeMake(count * btnW, 0);
            _topTitleView.showsHorizontalScrollIndicator = NO;
/***********比类型一增加的部分⏫*************************************/
        }
    }
}
...
/******** 设置标题scrollview的偏移量⏬*****************************/
    ...
    CGFloat offsetX = button.center.x - ZTScreenW * 0.5;
    
    if (offsetX < 0) {
        offsetX = 0;
    }
    
    CGFloat maxOffsetX = self.topTitleView.contentSize.width - ZTScreenW;
    ...
    self.title = _selectButton.titleLabel.text;
/******** 设置标题scrollview的偏移量下⏫****************************/
/***********比类型一增加的部分⏫*************************************/
